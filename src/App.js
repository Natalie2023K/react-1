...
import Contact from "./component/contact_info";
...
<Details title='Деталі властивості'property__details={data.property_details}/>

    <Description title='Про Сусідів' children={data.neighborhood_info}/>
    <Amenities title='Зручності' children={data.amenities}></Amenities>
...
></Contact>
<Properties title='Додаткові властивості' properties={data.additional_properties}></Properties>
